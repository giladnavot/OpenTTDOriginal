...
4. **Check if the issue has been fixed** — try to reproduce it using the latest `nightly` build of OpenTTD, available from <https://www.openttd.org>
